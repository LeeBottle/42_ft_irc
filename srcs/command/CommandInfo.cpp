...
CommandInfo::CommandInfo(ChannelManager &channels,
...
void    CommandInfo::executeNames(Client &client, const Parser &message)
{
...
void    CommandInfo::executeWho(Client &client, const Parser &message)
{
    const std::vector<std::string>          &params = message.getParams();
    Channel                                 *channel;
...
void    CommandInfo::executeTopic(Client &client, const Parser &message)
{
    const std::vector<std::string>  &params = message.getParams();
    Channel                         *channel;
