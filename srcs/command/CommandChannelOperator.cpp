...
CommandChannelOperator::CommandChannelOperator(ChannelManager &channels,
    ClientManager &clients)
    : CommandChannelBase(channels, clients)
{
}

CommandChannelOperator::~CommandChannelOperator()
{
}

void    CommandChannelOperator::handleInvite(Client &client, const Command &command)
{
...
void    CommandChannelOperator::handleKick(Client &client, const Command &command)
{
    const std::vector<std::string>  &params = command.getParams();
    Channel                         *channel;
    Client                          *targetClient;
