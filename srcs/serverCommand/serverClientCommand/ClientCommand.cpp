...
{
    reply(client, ":ircserv 421 "
        + target(client)
        + " " + message.name() + " :Unknown command\r\n");
    return (true);
}

void    ClientCommand::reply(Client &client,
